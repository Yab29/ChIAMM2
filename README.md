## **ChIAMM2**
## Introduction
**Ch**romatin **I**nteraction **A**nalysis with **P**aired-**E**nd **T**ag (**ChIA-PET**) sequencing is a technology to study genome-wide long-range chromatin interactions bound by protein factors. **ChIAMM2** the updated form of [**ChIAMM**](https://github.com/Yab29/ChIAMM), used to find the long-range chromatin interactions from the ChIA-PET experiments data using the truncated negative binomial regression model in the Bayesian framework.  
...
|------|------|------|-----|-------|------|------|-----|
|chr1|	919077|	919880|	chr1|	998944|	999920|	4|	0.63|
