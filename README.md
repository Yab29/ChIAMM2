...
> 6) &nbsp; bayesplot ( ‚â?.7.1)<br />
> 7) &nbsp; bayesplot ( ‚â?.7.1)<br />
> 8) &nbsp; ngs-tools (‚â?.2)<br />
### Data preparation
...
Call the variables tag count within anchor 1 and tag count within anchor 2 as tagcou1 and tagcou2 respectively, and compute the average of it call the variable name ‚ÄútagcouAvg‚Ä? 
...
> 2) &nbsp; then compute the average of it and call the variable name ‚ÄúselfAvg‚Ä? <br />
...
> 3) &nbsp; Compute the average of 5th column in mappability1.bed and mappability2.bed, and call the variable name ‚ÄúmappaAvg‚Ä?<br />
...
> 3) &nbsp; Compute the average of 5th column in the gc1.bed and gc2.bed and call variable name ‚ÄúgcAv‚Ä?<br />
